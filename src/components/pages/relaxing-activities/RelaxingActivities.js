...
import '../../../styles/pages/RelaxingActivities.css';
...
const ActivityCard = (obj) => {
    return (
        <Card className="activityCard whiteBox">
            ...
            <CardActions>
                <Button size="small">
                    <Link href={obj.link} underline="none" target={(obj.key==="exercise" || obj.key==="meditation") ? "_self" : "_blank"} rel="noopener">Learn More</Link>
                </Button>
            </CardActions>
        </Card>
    );
