...
import QuizIcon from '@mui/icons-material/Quiz'; //questionnaire Icon
...
import Reading from '../assets/images/relaxing-activities/Book.png';
import Videos from '../assets/images/relaxing-activities/Video.png';
import Memes from '../assets/images/relaxing-activities/Meme.png';
import Exercise from '../assets/images/relaxing-activities/Exercise.png';
...
import Games from '../assets/images/relaxing-activities/Games.png';
...
export const sidebarList = [
    ...
    { name: "Blogs", link: "/pages/blogs", icon: <LocalLibraryIcon /> },
    { name: "Questionnaire", link: "/pages/questionnaire", icon: <QuizIcon /> }
];
